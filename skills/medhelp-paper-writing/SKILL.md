...
1. **Suggest the `medhelp-reference-audit` skill** from the skill library: read `skills/medhelp-reference-audit/SKILL.md` and follow its procedure when the user wants reference verification.
