...
## Medical-First Kickoff

When the request is medical or biomedical, do not begin with a broad cross-domain search.

1. Ask up to 5 kickoff questions, preferring the first 3:
   - exact condition / population / exposure / intervention / outcome, ideally in PICO or PEO form
   - review type: narrative / systematic / scoping / meta-analysis
   - evidence priority and target deliverable: guidelines, RCTs, observational studies, preclinical work, evidence table, outline, full review, slides, etc.
   - time window and language limits
   - whether clinical guidelines or trial registries must be included
2. If the user leaves some fields unspecified, state the working assumptions before searching.
3. For medical reviews, prioritize sources in this order unless the task clearly needs something else:
   - PubMed / MEDLINE and PubMed Central
   - major society or government guidelines
   - ClinicalTrials.gov for ongoing or completed trial evidence
   - Cochrane and other reputable evidence syntheses
   - broader discovery tools such as Semantic Scholar, OpenAlex, or arXiv only as supplements, or for methods / computation papers
