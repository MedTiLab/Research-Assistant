        ...
        "task_blueprints": [
          {
            ...
            "recommended_skills": ["literature-review", "pubmed-database", "real-literature-trace", "citation-management"]
          },
          {
            ...
            "taskType": "analysis",
            "recommended_skills": ["literature-review", "citation-management", "research-lookup"]
          }
        ],
        "recommended_skills": ["literature-review", "pubmed-database", "real-literature-trace", "citation-management", "research-lookup"]
      },
      "ideation": {
        "required_elements": [
        ...
        "task_blueprints": [
          ...
          },
          {
            ...
            "taskType": "analysis",
            "recommended_skills": ["medhelp-idea-eval"]
          }
        ],
        "recommended_skills": ["medhelp-idea-generation", "medhelp-prepare-resources"]
      },
      "experiment": {
        "required_elements": [
        ...
        "task_blueprints": [
          {
            ...
            "recommended_skills": ["medhelp-experiment-dev", "academic-researcher"]
          },
          {
            "id": "experiment_run_analysis",
            "title": "Run baseline analysis and record outcomes",
            "description": "Execute baseline validation, save reports, figures, tables, and supporting files under their Experiment folders, and summarize findings and gaps.",
            "taskType": "analysis",
            "recommended_skills": ["medhelp-experiment-analysis"]
          }
        ],
        "recommended_skills": ["academic-researcher", "medhelp-experiment-dev", "medhelp-experiment-analysis"]
      },
      "publication": {
        "required_elements": [
        ...
        "task_blueprints": [
          {
            ...
            "taskType": "writing",
            "recommended_skills": ["medhelp-paper-writing"]
          },
          {
            ...
            "taskType": "writing",
            "recommended_skills": ["medhelp-paper-writing", "medhelp-figure-gen"]
          }
        ],
        "recommended_skills": ["medhelp-paper-writing", "medhelp-reference-audit", "medhelp-rclone-to-overleaf"]
      },
      "promotion": {
        "required_elements": [
