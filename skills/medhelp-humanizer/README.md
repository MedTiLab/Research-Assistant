...
A MedHelp skill that removes signs of AI-generated writing from text, making it sound more natural and human.

## Installation

Add this skill directory to your project’s skills path (or install it through your agent’s skill UI), then invoke it from the agent.
