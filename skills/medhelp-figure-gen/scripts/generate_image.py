...
def get_api_key(provided_key: str | None) -> str | None:
    ...
    if provided_key:
        return provided_key
    return (
        os.environ.get("MEDHELP_GEMINI_API_KEY")
        or os.environ.get("GEMINI_API_KEY")
        or os.environ.get("GOOGLE_API_KEY")
    )


def get_api_base_url(provided_base_url: str | None) -> str | None:
    """Get custom Gemini-compatible base URL from argument or environment."""
    if provided_base_url:
        return provided_base_url.rstrip("/")
    env_base_url = os.environ.get("MEDHELP_GEMINI_API_BASE_URL") or os.environ.get("GEMINI_API_BASE_URL")
...
def main():
    ...
    parser.add_argument(
        "--base-url", "-b",
        help="Optional Gemini-compatible API base URL (overrides GEMINI_API_BASE_URL env var)"
    )
    parser.add_argument(
        "--model", "-m",
    ...
    api_base_url = get_api_base_url(args.base_url)
    if api_base_url:
