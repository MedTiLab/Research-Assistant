...
export const CollapsibleSection: React.FC<CollapsibleSectionProps> = ({
  ...
  return (
    ...
    >
      <summary className="flex items-center gap-1.5 text-[13px] cursor-pointer py-0.5 select-none group-open/details:sticky group-open/details:top-0 group-open/details:z-10 group-open/details:bg-background group-open/details:-mx-1 group-open/details:px-1">
        <svg
