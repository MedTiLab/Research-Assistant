...
const TEMPLATE_NO_BRIEF = `Please help me set up my research pipeline using the medhelp-pipeline-planner skill. I have a rough idea for my research — guide me step by step to define it.\n\n`;

const TEMPLATE_NO_TASKS = `I already have a research brief but no tasks yet. Please use the medhelp-pipeline-planner skill to read my brief and generate tasks.\n\n`;
...
export default function PipelineOnboardingBanner({
  ...
  return (
    <div className="w-full mt-4 mb-2">
      <div className="relative rounded-xl border border-emerald-200/60 bg-gradient-to-br from-emerald-50/70 via-background to-muted/30 p-4 shadow-sm dark:border-emerald-900/50 dark:from-emerald-950/20 dark:via-background dark:to-card/50">
        <button
        ...
        <div className="flex items-start gap-3">
          <div className="mt-0.5 flex-shrink-0 w-8 h-8 rounded-lg bg-primary flex items-center justify-center">
            {isNoBrief ? (
          ...
          <div className="flex-1 min-w-0 space-y-2.5">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-primary-foreground rounded-lg bg-primary hover:bg-primary/90 transition-all shadow-sm"
            >
