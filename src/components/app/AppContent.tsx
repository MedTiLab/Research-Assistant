...
export default function AppContent() {
  ...
  useEffect(() => {
    ...
    const title = typeof reminder.title === 'string' ? reminder.title : t('workbench:notifications.title');
        ...
        >
          ...
          {!primaryNavCollapsed && (
            <div
              ...
              aria-label={t('explorer.resizeNav')}
            />
          )}
          {projectPaneVisible && (
            <div
              ...
              role="separator"
              aria-orientation="vertical"
              aria-label={t('explorer.resizeProjects')}
            />
          )}
        </div>
      ) : (
