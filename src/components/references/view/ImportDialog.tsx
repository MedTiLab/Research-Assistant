...
export default function ImportDialog({ zoteroStatus, projectName, onRefreshZoteroStatus, onClose, onComplete }: ImportDialogProps) {
  ...
  const handleSyncClick = async () => {
    ...
    try {
      ...
      await onRefreshZoteroStatus?.().catch(() => {});
    }
  };
