 ...
 * @param {boolean} isPlainShell - Use disabled bare shell mode vs Claude CLI (default: Agent session)
...
function StandaloneShell({
  ...
  // Bare shell is disabled; a project without an existing session starts an Agent CLI session instead.
