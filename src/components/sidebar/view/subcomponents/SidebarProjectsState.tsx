  ...
  if (projectsCount === 0) {
    return (
      <div className="text-center py-12 md:py-8 px-4">
        ...
        <h3 className="text-xs font-medium text-foreground mb-2 md:mb-1">{t('projects.noProjects')}</h3>
        <p className="text-xs text-muted-foreground">{t('projects.runClaudeCli')}</p>
      </div>
    );
  }
